    ...
    <div style={{ fontFamily: "'DM Sans', 'Inter', sans-serif", minHeight: "100vh", background: "#fff" }}>
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* Hero */
          .article-hero { height: 240px !important; }
          .article-hero-text { padding: 0 16px 5px !important; }
          .article-hero-title { font-size: 16px !important; line-height: 1.35 !important; }
          ...
          .article-content th, .article-content td { padding: 8px 10px !important; font-size: 12px !important; }
        ...
        .toc-link:hover { background: #f1f5f9; color: #0A1628; }
        .toc-link.active { background: #f0fdf8; color: #00C389; font-weight: 500; }
        .toc-link-h3 { padding-left: 16px; }
      ...
      <div className="article-hero" style={{
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(to top, rgba(0,0,0,0.97) 0%, rgba(0,0,0,0.88) 15%, rgba(0,0,0,0.45) 30%, rgba(0,0,0,0.15) 45%, transparent 60%)" }} />
      ...
      {/* ─── BREADCRUMB ─── */}
      <div className="breadcrumb" style={{ background: "#f7f8fa", borderBottom: "1px solid #e8ecef", padding: "10px 40px", fontSize: "12px", color: "#64748b", display: "flex", alignItems: "center", gap: "6px", flexWrap: "wrap" }}>
      ...
      <div className="article-wrapper" style={{ maxWidth: "1440px", margin: "0 auto", padding: "32px 40px" }}>
        <div className="article-grid" style={{ display: "grid", gridTemplateColumns: "22% minmax(0, 1fr) 18%", gap: "32px", alignItems: "start" }}>
          ...
          {/* SIDEBAR TRÁI */}
          <aside className="sidebar-left" style={{ position: "sticky", top: "90px", alignSelf: "start" }}>
