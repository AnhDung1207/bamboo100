...
export default function TaoMoiBaiViet() {
  ...
  const handleTitleChange = (title: string) => setForm({ ...form, title, slug: generateSlug(title) })
    ...
    <div style={{ fontFamily: "'DM Sans', 'Inter', sans-serif", minHeight: "100vh", background: "#f8fafc" }}>
      ...
      <div className="editor-topbar" style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <h1 className="editor-topbar-title" style={{ fontSize: "15px", fontWeight: 600, color: "#0A1628" }}>Viết bài mới</h1>
        </div>
              ...
              <div style={{ padding: "12px 24px", borderBottom: "0.5px solid #e2e8f0", background: "#f8fafc", display: "flex", gap: "4px", flexWrap: "wrap" }}>
                ...
                {[
                  ...
                  <button key={btn.cmd} onMouseDown={(e) => {
                    e.preventDefault()
                    if (btn.cmd === "h2") { const v = document.queryCommandValue("formatBlock"); document.execCommand("formatBlock", false, v === "h2" ? "p" : "h2") }
                    else if (btn.cmd === "h3") { const v = document.queryCommandValue("formatBlock"); document.execCommand("formatBlock", false, v === "h3" ? "p" : "h3") }
                    else if (btn.cmd === "formatBlock") { const v = document.queryCommandValue("formatBlock"); document.execCommand("formatBlock", false, v === "blockquote" ? "p" : "blockquote") }
